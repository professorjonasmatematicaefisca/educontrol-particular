...
export const questions: Question[] = [
  {
    ...
    unit: '',
    init: '',
    banner: 'linear-gradient(135deg, #ca8a04 0%, #facc15 100%)',
    emoji: '🚀⬇️',
  ...
  },
  {
    ...
    correct: 5,
    init: 0,
    banner: 'linear-gradient(135deg, #33691e 0%, #facc15 100%)',
    emoji: '💦🎯',
  ...
  },
  {
    ...
    correct: 4,
    init: '',
    banner: 'linear-gradient(135deg, #ca8a04 0%, #66bb6a 100%)',
    emoji: '🏁🏄‍♂️',
  ...
  },
  {
    ...
    unit: '',
    init: '',
    banner: 'linear-gradient(135deg, #ca8a04 0%, #9ccc65 100%)',
    emoji: '🛹📉',
  ...
  },
  {
    ...
    unit: '',
    init: '',
    banner: 'linear-gradient(135deg, #ca8a04 0%, #cddc39 99%)',
    emoji: '🫧🧗‍♂️',
  ...
  },
  {
    ...
    correct: 20,
    init: 0,
    banner: 'linear-gradient(135deg, #ca8a04 0%, #dce775 100%)',
    emoji: '🌡️👶',
  ...
  },
  {
    ...
    unit: '',
    init: '',
    banner: 'linear-gradient(135deg, #1b5e20 0%, #facc15 100%)',
    emoji: '🛟⚙️',
